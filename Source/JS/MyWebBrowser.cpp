...
void UMyWebBrowser::BindUObject(const FString& Name, UObject* Object, bool bIsPermanent /*= true*/)
{
	if (WebBrowserWidget.IsValid())
	{
...
void UMyWebBrowser::UnbindUObject(const FString& Name, UObject* Object, bool bIsPermanent /*= true*/)
{
	if (WebBrowserWidget.IsValid())
	{
